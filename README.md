<!-- Profile Header -->
<h1 align="center">Hi 👋, I'm Junaid Ali Khan</h1>
<h3 align="center">💻 Web Developer | Backend Engineer | AI/ML Enthusiast</h3>

---

## 🚀 About Me
I'm a passionate and self-driven developer who loves building **full-stack web applications from scratch**.  
Currently focused on creating **performant and scalable products** using modern web technologies.

- 🔹 **Frontend:** React.js, Next.js, Tailwind CSS, Shadcn/UI  
- 🔹 **Backend:** Node.js, Express, Python  
- 🔹 **Databases:** MongoDB, PostgreSQL, MySQL, SQLite  
- 🔹 **Tools & DevOps:** Git, GitHub, Vercel, AWS (S3, EC2), Docker  
- 🔹 **AI/ML Curious:** Exploring AI/ML concepts & building my PC for ML workloads  

---

## 🎯 What I Enjoy
- 🛠 Building **full-stack applications** with clean architecture  
- ⚙️ Integrating **APIs & cloud services** (AWS, Stripe, etc.)  
- 🔍 Solving **backend challenges** with SQL & data modeling  
- 🚀 Deploying **production-ready apps**  
- 🤖 Exploring **AI & ML** in practical use cases  
